%%
classdef mission_control_v2_ANTI < matlab.apps.AppBase
    % ╔══════════════════════════════════════════════════════════════╗
        ...
        function onEStop(app, ~)
            ...
            if ~app.OfflineMode
                ...
                try
                    ...
                    app.GoalMsg.pose.position.x = app.RobotX;
                    app.GoalMsg.pose.position.y = app.RobotY;
                    app.GoalMsg.pose.position.z = 0;
                    app.GoalMsg.pose.orientation.w = 1;
                    app.GoalMsg.pose.orientation.x = 0;
                    app.GoalMsg.pose.orientation.y = 0;
    ...
    methods (Access = public)
        ...
        function app = mission_control_v2_ANTI
