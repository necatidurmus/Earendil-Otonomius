function generate_mission_library()
% GENERATE_MISSION_LIBRARY  13 dünya × 4 senaryo = 52 mission dosyası oluşturur.
%   ~/zeynep_missions/ dizinine kaydeder.
...
function worlds = getAllWorlds()
    ...
    worlds(idx).wp_safe      = [0 0 0; 0 8 0; 8 8 0; 8 0 0; 8 -8 0; 0 -8 0; -8 -8 0; -8 0 0; 0 0 0];
    worlds(idx).wp_challenge = [0 0 0; 6 6 45; -6 6 135; -6 -6 225; 6 -6 315; 10 0 0; 0 10 90; -10 0 180; 0 0 0];
    worlds(idx).wp_speed     = [0 0 0; 0 20 0; 0 -20 180; 20 0 90; -20 0 270; 0 0 0];
    worlds(idx).wp_precision = [0 0 0; 1 1 45; -1 1 135; -1 -1 225; 1 -1 315; 0 0 0];

    % 4. industrial
    idx=idx+1; worlds(idx).key='industrial'; worlds(idx).type='indoor';
    worlds(idx).wp_safe      = [0 0 0; -4 0 0; -4 8 90; 4 8 0; 4 -8 270; -4 -8 180; 0 0 0];
    worlds(idx).wp_challenge = [0 0 0; -4 3 90; -4 -3 270; 4 3 90; 4 -3 270; -8 0 180; 8 0 0; 0 0 0];
    worlds(idx).wp_speed     = [0 0 0; 0 10 0; 0 -10 180; 0 0 0];
    worlds(idx).wp_precision = [0 0 0; 0 2 0; 0 -2 180; 2 0 90; -2 0 270; 0 0 0];
