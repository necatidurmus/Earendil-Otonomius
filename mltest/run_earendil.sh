#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════════
#  mltest/run_earendil.sh — Earendil Environment Başlatıcı (MATLAB-Ready)
#
#  Gazebo + Nav2 başlatır, waypoint testi BAŞLATMAZ.
#  MATLAB arayüzünden waypoint gönderilmesini bekler.
#
#  Kullanım:
#    ./mltest/run_earendil.sh
#    ./mltest/run_earendil.sh --rviz
#    ./mltest/run_earendil.sh --no-restart
# ═══════════════════════════════════════════════════════════════════════════
...
echo ""
echo -e "${BOLD}${CYAN}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}${CYAN}║   EARENDIL ENV — MATLAB-CONTROLLED TEST (mltest)       ║${NC}"
echo -e "${BOLD}${CYAN}╚══════════════════════════════════════════════════════════╝${NC}"
echo ""
